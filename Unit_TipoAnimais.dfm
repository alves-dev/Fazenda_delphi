object Form_TipoAnimais: TForm_TipoAnimais
  Left = 0
  Top = 0
  Caption = 'Tipos de Animais'
  ClientHeight = 600
  ClientWidth = 800
  Color = clBtnFace
  ...
  object DBGrid_TipoAnimais: TDBGrid
    Left = 517
    Top = 0
    Width = 284
    Height = 601
    DataSource = DataModule1.DataSource_TipoAnimais
    ...
    TitleFont.Style = []
    OnDblClick = DBGrid_TipoAnimaisDblClick
    OnKeyDown = DBGrid_TipoAnimaisKeyDown
    OnKeyPress = DBGrid_TipoAnimaisKeyPress
    OnKeyUp = DBGrid_TipoAnimaisKeyUp
    Columns = <
      item
        Expanded = False
        FieldName = 'COD_TIPO'
